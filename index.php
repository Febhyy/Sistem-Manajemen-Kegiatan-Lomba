...
<?php 
    if (empty ($_SESSION['email']) AND empty($_SESSION['passuser'])) {
        ...
        echo "<center> Untuk mengakses Sistem Manajemen Kegiatan Lomba PSSI <br> <b> anda harus login terlebih dahulu</b>";
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><img src="logo-pcr.png"></a> 
            </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a  href="?page=club"><i class="fa fa-users fa-2x"></i> Club Sistem Informasi</a>
                    </li>

                    <li>
                        <a  href="?page=pengajuanlomba"><i class="fa fa-book fa-2x"></i> Pengajuan lomba</a>
                    </li>

                    <li>
                        <a  href="?page=prestasi"><i class="fa fa-database fa-2x"></i> Prestasi</a>
                    </li>
